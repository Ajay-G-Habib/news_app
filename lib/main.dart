        ...
        drawer: Drawer(
          child: ListView(
            ...
            children: <Widget>[
              ...
              // Ajay:Avoid the following line: just keep it as commented
  ...
  Future<void> getNews({
    ...
    if (channel != null) {
      ...
      baseApi =
          ...
          "https://newsapi.org/v2/top-headlines?pageSize=10&page=$pageNum&sources=$channel&apiKey=ff49425766b6483fb83a99908ca339b1";
    }
    if (searchKey != null) {
      country = null;
      catagory = null;
